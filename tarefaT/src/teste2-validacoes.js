...
(async () => {
    ...
    const cliente1 = await Funcionario.create({ nome: "Alberto" }); // Cliente inserido com sucesso!
    const cliente2 = await Funcionario.create({ nome: "A" }); // SequelizeValidationError :: Problema na inserção!
